	...
	<view class="content">
		<view class="body">
			<view class="head-body">
				...
				<view>
					<view class='pr40' style="display: inline-block;"><uni-icon type="arrowup" size='26' color='#333' @click='prevDeta'/></view>
					<view style="display: inline-block;"><uni-icon type="arrowdown" size='26' color='#333' @click='nextDate' /></view>
				</view>
			</view>
		...
		.body {
			...
			.mian-body {
				...
				.mian-bolck {
					...
					padding: 8upx 0;
					// min-height: calc(850upx / 7 - 26upx);
