<template>
	<view class="lz-numinput lz-row lz-jc--between lz-ai--stretch" :class="['lz-numinput__skin--' + skin,{'lz-numinput--hidebtn':!!hideBtnDisabled,'hastap':hasTap}]">
		<view class="lz-numinput__btnbox lz-numinput__btnbox--down lz-cc" :class="[{'lz-numinput__btnbox--disabled' : disabledMin}]">
			<view @tap="btntap" data-type="down" class="lz-numinput__btn lz-cc" style="border-radius: 10upx;" :class="['lz-numinput__btn--' + btnTheme]">
				<view class="lz-numinput__icon lz-iconfont lz-icon-jianhao" style="text-align: center; width: 20px; height: 20px; font-size: 20px;">-</view>
			</view>
		</view>
		<view class="lz-numinput__inputbox lz-item lz-col lz-jc--center lz-ai--center" :style="inputStyle">
			<input type="digit" class="lz-numinput__input lz-item lz-row lz-jc--center lz-ai--center" @longpress="inputlongtap"
			 @change="inputchange" :name="inputName" :value="inputValue" :disabled="if_disabled_input" v-show="if_show_num" style="font-weight: bold;color: #333;" />
		</view>
		<view class="lz-numinput__btnbox lz-numinput__btnbox--up lz-cc" :class="[{'lz-numinput__btnbox--disabled' : disabledMax}]">
			<view @tap="btntap" data-type="up" class="lz-numinput__btn lz-cc" style="border-radius: 10upx;" :class="['lz-numinput__btn--' + btnTheme]">
				<view class="lz-numinput__icon lz-iconfont lz-icon-jiahao" style="text-align: center; width: 20px; height: 20px;font-size: 20px;">+</view>
			</view>
		</view>
	</view>
</template>
